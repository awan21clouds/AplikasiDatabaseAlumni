...
/**
 * KerjaviewId generated by hbm2java
 */
public class KerjaviewId  implements java.io.Serializable {
    ...
    public KerjaviewId(String nim, Date tanggalMulai) {
        this.nim = nim;
        this.tanggalMulai = tanggalMulai;
    }
    public KerjaviewId(String nim, Date tanggalMulai, Integer core) {
       this.nim = nim;
       this.tanggalMulai = tanggalMulai;
       this.core = core;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof KerjaviewId) ) return false;
		 KerjaviewId castOther = ( KerjaviewId ) other; 

...
/**
 * StudiviewId generated by hbm2java
 */
public class StudiviewId  implements java.io.Serializable {
    ...
    public StudiviewId(String nim, Date tanggalMulai) {
        this.nim = nim;
        this.tanggalMulai = tanggalMulai;
    }
    public StudiviewId(String nim, Date tanggalMulai, Integer core) {
       this.nim = nim;
       this.tanggalMulai = tanggalMulai;
       this.core = core;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof StudiviewId) ) return false;
		 StudiviewId castOther = ( StudiviewId ) other; 

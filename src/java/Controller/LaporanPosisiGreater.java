 ...
 */
@Controller
public class LaporanPosisiGreater {
...
/*--------------------------------------------------------ALL--------------------------------------------------------*/        
    @RequestMapping(value="/rekapPosisiGreater", method=RequestMethod.GET)
    ...
    public JSONArray getProdiAll(){
        ...
        Iterator iterKontak = laporanDAO.getLaporanGreater(group).iterator();

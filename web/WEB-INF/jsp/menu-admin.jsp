        ...
        <div class="container">
            <div class="nav-collapse" >
                ...
                <ul class="nav pull-left">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Manajemen Data</a>
                        <ul class="dropdown-menu">
                            <!--li><a href="user-display.htm">User</a></li-->
                            <li><a href="jeniskontak-display.htm">Jenis Kontak</a></li>
                            <li><a href="peminatan-display.htm">Peminatan</a></li>
                            <li><a href="prodi-display.htm">Program Studi</a></li>
                            <li><a href="user-pegawai.htm">Pegawai</a></li>
                            <!--li class="dropdown-submenu">
                                <a tabindex="-1" href="#" id="sub-user">User</a>
                                <ul class="dropdown-menu" id="submenu-user">
                                    <li><a href="user-pegawai.htm">Pegawai</a></li>
                                    <li><a href="user-mahasiswa.htm">Mahasiswa</a></li>
                                    <li><a href="user-alumni.htm">Alumni</a></li>
                                </ul>
                            </li-->
                        </ul>
                    </li>

...
<div id="wrap">
    <div class="container" id="laporan-posisi-ipk-gr">
        <div class="page-header">
            <h1>Posisi Alumni Berdasarkan IPK >= 2.75 </h1>
        </div>
        <form:form method="POST" cssClass="form-horizontal" action="laporan-detail.htm">
            ...
            <table class="table table-striped table-bordered table-hover" id="tableAll">
                <thead>  
                    <tr>  
                        ...
                        <th style="text-align: center">Kerja</th>  
                        <th style="text-align: center">Wirausaha</th>  
